...
1.mkdir -p log tmp/pids public/assets app/stylesheets/brandable_css_brands
2.touch app/stylesheets/_brandable_variables_defaults_autogenerated.scss
3. Tests: RAILS_ENV=test rake db:migrate