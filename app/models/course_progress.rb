...
class CourseProgress
  ...
  def requirements
    ...
    @_requirements ||= modules.flat_map { |m| m.completion_requirements_visible_to(@user, :is_teacher => false, :assignment_visibilities => true, :discussion_visibilities => true, :page_visibilities => true, :quiz_visibilities => true ) }.uniq
